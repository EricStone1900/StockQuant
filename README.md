...
- V1～V2.5 已有可运行的服务、数据库迁移和 Web 验收切片；当前开发重点为 V2 数据采集观察与验收。
- 自动测试、Docker/ARM64 和部分阶段人工验收已有证据；真实来源盘中稳定性、20 日/60 日观察仍不得提前视为通过。
- 当前阶段：[V2 数据与回放](./docs/prd/v2-data-and-replay/README.md)，V1.1 仍保留为历史基线。
