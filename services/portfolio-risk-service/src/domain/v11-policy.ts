...
export function isSimulationModeAllowed(environmentMode: string | undefined, brokerMode: string | undefined, liveTradingEnabled: string | undefined): boolean {
  return (environmentMode === "PAPER" || environmentMode === "BACKTEST") && brokerMode === "FAKE" && liveTradingEnabled === "false";
}
