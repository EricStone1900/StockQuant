...
import { isSimulationModeAllowed } from "./domain/v11-policy.js";

async function bootstrap() {
  if (!isSimulationModeAllowed("PAPER", process.env.STOCKQUANT_BROKER_MODE, process.env.STOCKQUANT_LIVE_TRADING_ENABLED)) {
