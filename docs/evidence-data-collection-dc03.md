...
状态校准（2026-09-17）：上文“正式 Worker 保持显式禁用”属于 2026-09-12 的历史状态；当前唯一 20 只订阅已按受控任务启用，运行期健康和收盘后补采证据见 `evidence/dc08a/health-report.json` 与 `daily-report-2026-09-17.json`。全天盘中观察仍需实际交易日累计。
