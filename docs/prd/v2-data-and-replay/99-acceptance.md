...
| [V2.2 历史分钟数据导入与校验](./02-minute-data-import.md) | PASS（代码、Docker、统一场景） | 待用户确认 | `docs/evidence-v2.2.md`；normal `8bcf130e-ed3e-4552-9dd1-74dbbb85b9a0`；rejection `a8571fdf-1993-43e6-8eb5-99f9a56a2cef`；recovery `30f6f2ef-a6c8-4fe2-bead-d49f6934e0bb` | Parquet、持久化分区和真实用户文件导入未覆盖 | NOT_RUN |
