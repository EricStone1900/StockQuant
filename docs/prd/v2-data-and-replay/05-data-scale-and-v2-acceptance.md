...
- [ ] 按版本数据阶梯扩容，Fixture 的10～20只约60交易日分钟切片及 BaoStock 真实 20 标的×约60交易日 5 分钟切片已完成（55,680 行、20/20 SHA-256 与质量检查通过）；BaoStock 已筛选出 5,219 个已上市 A 股，并完成 5/100/500/5219 标的 2019～2024 日线分档、Manifest、断点恢复、幂等和逐文件完整性验证。全量日线已归档并在隔离恢复副本校验 5,219/5,219 SHA-256；分钟级全量、长期限频稳定性和可覆盖60日的第二免费分钟源仍待验证，Ubuntu 人工子项已确认通过。
