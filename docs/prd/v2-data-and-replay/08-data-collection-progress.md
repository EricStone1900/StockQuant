...
| DC-07 部署运维 | IN_PROGRESS | PASS：Mac ARM64 Compose 配置/健康、market-data 重启约12.053s恢复、1CPU/1GiB资源限制、PostgreSQL备份SHA-256和隔离恢复19张表 | NOT_RUN | [DC-07证据](../../evidence-data-collection-dc07.md) | Ubuntu实机、告警出口故障/恢复、宿主机重启续跑、完善操作手册 |
