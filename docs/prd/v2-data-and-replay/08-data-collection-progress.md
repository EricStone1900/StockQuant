...
| DC-06 多项目Web/API | IN_PROGRESS | PASS：项目规则16/16单测、TypeScript检查、权限/分页/导出/去重HTTP烟测 | NOT_RUN | [DC-06证据](../../evidence-data-collection-dc06.md) | 接入正式认证、持久配额/公平队列、真实分页导出和Web/验收中心E2E |
