...
2026-09-17 V2.5 分阶段容量：BaoStock 100 只×60 交易日分钟归档完成 288,000 根 Bar，逐文件完整性与 48 窗口校验 PASS；证据为 `evidence/dc08a/historical-coverage-100x60-2024-01-02-2024-04-02.json`。500/1000 只尚未启动，需先复核资源与限频，再在非交易时段继续。
