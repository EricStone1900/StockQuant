...
| DC-06 多项目Web/API | IN_PROGRESS | PASS：项目规则16/16单测、PostgreSQL集成9/9、数据库令牌认证/权限/分页/导出/去重HTTP烟测 | NOT_RUN | [DC-06证据](../../evidence-data-collection-dc06.md) | 公平队列指标、真实Artifact分页导出、脱敏和Web/验收中心E2E |
