...
2026-09-18 V2.5 500只分钟容量：BaoStock 500 只×60 交易日归档完成 1,440,000 根 Bar，逐证券完整性、每日48窗口、重复键、OHLCV 和 Manifest SHA 校验 PASS；同目录续跑退出0且约9秒内跳过已完成证券，未重复下载。证据为 `evidence/dc08a/historical-coverage-500x60-2024-01-02-2024-04-02.json`。资源峰值与恢复副本 SHA 仍待补充，暂不进入1000只档。
