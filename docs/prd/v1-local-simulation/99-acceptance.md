...
| [V1.4 日线历史回测与可核对报告](./04-daily-backtest.md) | PASS（代码/容器场景） | NOT_RUN（待用户 Web 验收） | `8752415c-09a8-4fa9-a22c-e59310536197`、`d272ade6-9d63-40d7-abb1-6e34cdcf79c3`、`4b446e1d-f5c6-42c0-9151-d7f5aa180c8f` | `pnpm verify:stage -- --stage V1.4 --suite code`；三场景 COMPLETED；`pnpm test:e2e`：4 passed | 当前为小样本合成日线 Fixture；真实全量 A 股数据、真实券商和跨重启回测持久化未验证 |
