...
| [V1.5 无人逐笔操作、故障恢复与 V1 验收](./05-scheduling-and-recovery.md) | PASS（代码/容器场景） | PASS（用户已完成人工 Web 验收，2026-09-09） | `25fe0718-5a76-4477-a02b-5e954f621dde`、`48e32a09-4901-424f-8585-7b01ab9f83f7`、`113fea95-5fee-42ee-b702-f8423b8a173c` | 重建 Docker 栈；代码套件 PASS；三场景和 check-only PASS；`pnpm test:e2e`：5 passed | 当前为可重复的调度/恢复模拟；真实 NATS、Temporal、Ubuntu 烟测和长周期观察未验证 |
