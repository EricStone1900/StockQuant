...
- 20 个实际交易日观察：已开始；截至 2026-09-15 当前有效日为 `1/20`，2026-09-14 因盘中超时错误不计数，未用加速 Fixture 冒充观察期。
...
- 平台 API 与市场数据服务 TypeScript typecheck、V2.4 单元测试、行情预检和 DC-08A 脚本单元测试均通过。真实观察门禁当前为 `1/20`。
